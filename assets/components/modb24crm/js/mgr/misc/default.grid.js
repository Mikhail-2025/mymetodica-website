modB24CRM.grid.Default = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {},
        cls: config['cls'] || 'main-wrapper modb24crm-grid',
        autoHeight: true,
        paging: true,
        remoteSort: true,
        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                ...
                if (rec.data['active'] != undefined && rec.data['active'] == 0) {
                    cls.push('modb24crm-row-inactive');
                }
                return cls.join(' ');
            }
        },
    });
    modB24CRM.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(modB24CRM.grid.Default, MODx.grid.Grid, {
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = modB24CRM.utils.getMenu(row.data['actions'], this, ids);
...
Ext.reg('modb24crm-grid-default', modB24CRM.grid.Default);