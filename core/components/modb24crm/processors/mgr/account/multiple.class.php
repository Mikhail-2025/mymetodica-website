...
class modB24AccountMultipleProcessor extends modProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $response = $this->modx->runProcessor('mgr/account/' . $method, array('id' => $id), array(
...
return 'modB24AccountMultipleProcessor';