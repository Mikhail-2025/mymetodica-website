<a class="shorts__slider-item swiper-slide" href="{$_pls['tv.videoshorts_link']}" data-fancybox>
	...
	<div class="shorts__slider-img">
		<picture>
			<source srcset="{$_modx->runSnippet('!pThumb', ['input' => $_pls['tv.videoshorts_img'], 'options' => '&w=319&h=556&f=webp'])}" type="image/webp">
	        <img src="{$_modx->runSnippet('!pThumb', ['input' => $_pls['tv.videoshorts_img'], 'options' => '&w=319&h=556&zc=1'])}" alt="">
		</picture>
	</div>
