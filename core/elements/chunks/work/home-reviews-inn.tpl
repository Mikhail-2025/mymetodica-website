<div class="reviews__item">
	<div class="reviews__item-head">
		<div class="reviews__item-author">
			<p>{$pagetitle}</p>
			{set $val_rating = 0}
			{if $_pls['tv.review_rating'] == 5}
			    {set $val_rating = 100}
			{elseif $_pls['tv.review_rating'] == 4.5}
			    {set $val_rating = 92}
			{elseif $_pls['tv.review_rating'] == 4}
			    {set $val_rating = 80}
			{elseif $_pls['tv.review_rating'] == 3.5}
			    {set $val_rating = 71}
			{elseif $_pls['tv.review_rating'] == 3}
			    {set $val_rating = 60}     
			{/if}
		...
		<div class="reviews__item-date">{$_pls['tv.review_date']}</div>
	</div>
	<div class="reviews__item-descr">
		{$content}
	</div>
	{if $_pls['tv.review_link']}
	<div class="end-box">
		<a target="_blank" class="btn dark" href="{$_pls['tv.review_link']}">View review </a>
	</div>
	{/if}
</div>