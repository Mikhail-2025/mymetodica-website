<div class="compare__item">
	<div class="compare__item-img">
		<div class="jsTwenty">
			<img src="{$_modx->runSnippet('!pThumb', ['input' => $_pls['photo_before_img'], 'options' => '&w=440&h=400&zc=1'])}" alt="">
			<img src="{$_modx->runSnippet('!pThumb', ['input' => $_pls['photo_after_img'], 'options' => '&w=440&h=400&zc=1'])}" alt="">
		</div>
	</div>
