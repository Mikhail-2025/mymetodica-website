...
<head>
	...
	{else}
	    ...
	    <meta property="og:url" content="https://mymetodica.com/{$_modx->resource.uri}" />
	    ...
	    <meta property="og:image" content="https://mymetodica.com/{$_modx->resource.og_image}" />
	    <meta property="og:image:secure_url" content="https://mymetodica.com/{$_modx->resource.og_image}" />
	    <meta property="og:image:type" content="image/png" />
	    <meta property="og:image:width" content="800" />
	    <meta property="og:image:height" content="800" />
	    <meta property="og:image:alt" content="{$_modx->resource.og_image_alt ?: $_modx->resource.pagetitle | notags}" />
	    {else}
	    <meta property="og:image" content="https://mymetodica.com/assets/images/og-default.jpg" />
	    <meta property="og:image:type" content="image/jpeg" />
	    {/if}

	    <meta name="twitter:card" content="summary_large_image" />
	    {if $_modx->resource.og_image}
	    <meta name="twitter:image" content="https://mymetodica.com/{$_modx->resource.og_image}" />
	    {/if}
