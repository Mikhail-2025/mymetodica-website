	...
	<main>
		<div class="services-main">
			<div class="services-main__banner">
				<div class="container">
					<div class="services-main__banner-inner{if $_modx->resource.show_ai_button == '1'} services-main__banner-inner--ai{/if}">
						<picture>
				...
				<div class="container">
					<div class="services-main__inner">
						...
						<div class="services-main__categories">
							...
							{if $_modx->resource.success_story_ids}<a class="services-main__link jsAnchorLink" href="#successstory">Success Story</a>{/if}
							<a class="services-main__link jsAnchorLink" href="#reviews">Reviews</a>
						</div>
						
						{if $_modx->resource.show_ai_button == '1'}
						    <div class="ai_wrap--service">
		...
		{/if}
		{if $_modx->resource.success_story_ids}
		<div class="articles no-offset" id="successstory">
			<div class="container">
				<h2 class="main-heading">Success Story</h2>
			</div>
			<div class="slider-container">
				<div class="videos__slider swiper">
					<div class="swiper-wrapper">
						{$_modx->runSnippet('!pdoResources', [
							'parents' => 405,
							'resources' => $_modx->resource.success_story_ids,
							'depth' => 0,
							'limit' => 10,
							'includeTVs' => 'blog_img,blog_filter',
							'tpl' => '@FILE chunks/work/blog_row_inn.tpl',
