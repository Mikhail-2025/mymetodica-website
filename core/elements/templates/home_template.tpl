	...
	<main>
		...
		<div class="customers">
			<div class="customers__layout">
				...
				<!-- CSS бегущие строки. Для строки нужен дубликат с aria-hidden="true"-->
					...
					<div class="customers__items-wrap">
						<div class="customers__items marquee">
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-1.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-1.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-2.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-2.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-3.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-3.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-4.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-4.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-5.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-5.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
									<source srcset="assets/templates/site/img/webp/mq-6.webp" type="image/webp">
									<img src="assets/templates/site/img/mq-6.jpg" alt="">
								</picture>
							</a>
							<a class="customers__item" href="#">
								<picture>
